...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SECS 300       // Duration in seconds for the fan to run after all motors are disabled
 ...
 * the fan will on when any selected extruder is above the threshold.
 */
