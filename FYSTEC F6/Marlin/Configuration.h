...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,  100, 400, 440 }
 ...
 *    (0,0)
 */
// old sensor behind axis - capacity sensor
//#define X_PROBE_OFFSET_FROM_EXTRUDER 0       // X offset: -left  +right  [of the nozzle]
//#define Y_PROBE_OFFSET_FROM_EXTRUDER 50      // Y offset: -front +behind [the nozzle]
//#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.59   // Z offset: -below +above  [the nozzle]
...
// Preheat Constants
#define PREHEAT_1_TEMP_HOTEND 200 // PLA
#define PREHEAT_1_TEMP_BED     50
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_TEMP_HOTEND 230 // ABS
